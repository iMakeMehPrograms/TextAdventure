 ...
 if (eightiesMode == false) {
    ...
    public static void startGame (boolean isEighties, boolean isDebug) {
        if (isEighties == true) {
            ...
            System.out.println("You notice you have a tubular map burnt into your skin, as well as a rad engraving on the wall saying \"1\"!");
            while (!gameEnded) {
            ...
            System.out.println("You notice you have a map burnt into your skin, as well as an engraving on the wall saying \"1\".");
            while (!gameEnded) {
                room.findAndDisplayRoomInformation(room.findMoveOptions(room.currentRoom)); 
            }
        }
